...
const libToInteger = require('to-integer-x');

const {toInteger2016} = libToInteger;
const {toInteger2018} = libToInteger;
const MAX_SAFE_INTEGER = require('max-safe-integer');

const $toLength2016 = function toLength2016(value) {
